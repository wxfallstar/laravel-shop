...
function buttomActive(event){
	...
	if(event == "#buttom_home"){
		$("#buttom_home").find("img").attr("src","{{shop_asset('images/home_check.png')}}");
	}else if(event == "#buttom_classify"){
		$("#buttom_classify").find("img").attr("src","{{shop_asset('images/classify_check.png')}}");
	}else if(event == "#buttom_stroe"){
		$("#buttom_stroe").find("img").attr("src","{{shop_asset('images/store_check.png')}}");
	}else if(event == "#bottom_cart"){
		$("#bottom_cart").find("img").attr("src","{{shop_asset('images/cart_check.png')}}");
	}else if(event == "#bottom_member"){
		$("#bottom_member").find("img").attr("src","{{shop_asset('images/user_check.png')}}");
	}
}

function clearButton(){
	$("#buttom_home").find("img").attr("src","{{shop_asset('images/home_uncheck.png')}}");
	$("#buttom_classify").find("img").attr("src","{{shop_asset('images/classify_uncheck.png')}}");
	$("#buttom_stroe").find("img").attr("src","{{shop_asset('images/store_uncheck.png')}}");
	$("#bottom_cart").find("img").attr("src","{{shop_asset('images/cart_uncheck.png')}}");
	$("#bottom_member").find("img").attr("src","{{shop_asset('images/user_uncheck.png')}}");
}
